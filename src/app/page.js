        ...
        <div className="container mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="p-6 bg-gray-100 rounded-lg shadow-md">
              <img src="https://via.placeholder.com/100" alt="Ícone 1" className="mx-auto mb-4" />
              <h4 className="text-xl font-bold mb-2">Conteúdo Atualizado</h4>
              <p>Aprenda com as tecnologias mais recentes do mercado.</p>
            </div>
            <div className="p-6 bg-gray-100 rounded-lg shadow-md">
              <img src="https://via.placeholder.com/100" alt="Ícone 2" className="mx-auto mb-4" />
            ...
            <div className="p-6 bg-gray-100 rounded-lg shadow-md">
              <img src="https://via.placeholder.com/100" alt="Ícone 3" className="mx-auto mb-4" />
      ...
      <section id="testimonials" className="py-16 px-4">
        <div className="container mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="p-6 bg-gray-100 rounded-lg shadow-md">
              <img src="https://via.placeholder.com/100" alt="Aluno 1" className="rounded-full mx-auto mb-4" />
            ...
            <div className="p-6 bg-gray-100 rounded-lg shadow-md">
              <img src="https://via.placeholder.com/100" alt="Aluno 2" className="rounded-full mx-auto mb-4" />
            ...
            <div className="p-6 bg-gray-100 rounded-lg shadow-md">
              <img src="https://via.placeholder.com/100" alt="Aluno 3" className="rounded-full mx-auto mb-4" />
